const componentUtil = {
  ...
  getSelectedCustomerID: async () => {
    return Number(
      sessionStorage["selectedCustomerId"] !== undefined
  ...
  getCurrencySymbol: async () => {
    return sessionStorage["currencySymbol"] !== undefined
  ...
  getCurrencyPreference: async () => {
    return sessionStorage["currencyPreference"] !== undefined
      ? sessionStorage.getItem("currencyPreference")
      : "start";
  },
  ...
  getSelectedCSP: () => {
    ...
    return Number(
      sessionStorage["cspId"] !== undefined
        ? sessionStorage.getItem("cspId")
        : 100
    );
  },
  ...
  getCustomerImage: () => {
    return sessionStorage["customerImage"] !== undefined
      ? sessionStorage.getItem("customerImage")
      : "";
  },
