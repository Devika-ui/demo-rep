  ...
  const chartsData = [
    {
      ...
      headers: ["Subscription Name", "High", "Medium"],
      data: data,
      mapData: (row) => [
    ...
    {
      title: "Applications with High Impact Recommendations",
      headers: ["Applications", "value"],
      data: data1,
      mapData: (row) => [row.name || "N/A", row.value || 0],
    },
    {
      title: "Service Category with High Impact Recommendations",
      headers: ["Services", "value"],
      data: data2,
      mapData: (row) => [row.name || "N/A", row.value || 0],
    },
  ];
      ...
      <div className="export-container">
        ...
        <div>
          ...
          <div className="cmpHSA_buttonContainer">
            <ShareButtonCO className="cmpHSA_button" charts={chartsData} />
          </div>
        ...
        >
          <Box
            sx={{ marginTop: "-2.5rem", width: "97.3%", marginLeft: "-2.2rem" }}
          >
            <CostAllocationTable
              dummyData={dummyData}
              height="240px"
